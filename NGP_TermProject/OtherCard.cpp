...
{
	switch (m_iTripord[N_wjrfydvh][0])
	{
	case 1:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//빠른준비1.jpg"));
		lstrcpy(m_tStr[1], L"빠른 준비\n차징 속도가 증가한다.\n");
		break;
	case 2:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//반응속도1.jpg"));
		lstrcpy(m_tStr[1], L"사거리 증가\n공격 사거리가 증가한다.\n");
		break;
	case 3:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//급소타격.jpg"));
...
void Wjrfydvh::setTier2() {
	switch (m_iTripord[N_wjrfydvh][1])
	{
	case 1:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//마력조절2.jpg"));
		lstrcpy(m_tStr[2], L"마력 조절\n소모되는 마나를 감소시킨다.\n");
		m_bCheep = true;
		break;
	case 2:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//공격잇기.jpg"));
		lstrcpy(m_tStr[2], L"카드 뽑기\n무작위 난무카드를 뽑는다.\n");
		break;
	case 3:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//부위파괴강화2.jpg"));
...
void Wjrfydvh::setTier3() {
	switch (m_iTripord[N_wjrfydvh][2])
	{
	case 1:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//치명적인조준.jpg"));
		lstrcpy(m_tStr[3], L"치명적인 조준\n공중의 적에게도 피해를 입힌다.\n");
		break;
	case 2:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//약점포착3.jpg"));
...
void Wjrfydvh::__init__()
{
	...
	if (m_iTripord[N_wjrfydvh][2] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//적룡포3.png"));
		setTier3();
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_wjrfydvh][1] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//적룡포2.png"));
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_wjrfydvh][0] != 0) {
	...
	m_eCardname = (CardName)N_wjrfydvh;
	...
	swprintf_s(m_tStr[R_main], 100, L"자세를 잡고 집중한 뒤 전방으로 창을 찔러 %d의 피해를 준다.\n부위파괴 : %d\0", m_iDamage, m_iDestruction);
}
...
void Sktjsckd::setTier1() {
	switch (m_iTripord[N_sktjsckd][0])
	{
	case 1:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//난무특화.jpg"));
		lstrcpy(m_tStr[1], L"난무 특화\n일반 적에게 입히는 피해가 증가한다.\n");
		break;
	case 2:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//탁월한기동성.jpg"));
		lstrcpy(m_tStr[1], L"탁월한 기동성\n사용 후 이동속도가 증가한다.\n");
		break;
	case 3:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//화력조절1.jpg"));
...
void Sktjsckd::setTier2() {
	switch (m_iTripord[N_sktjsckd][1])
	{
	case 1:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//공격잇기.jpg"));
		...
		break;
	case 2:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//약점타격.jpg"));
...
void Sktjsckd::setTier3() {
	switch (m_iTripord[N_sktjsckd][2])
	{
	case 1:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//기술강화.jpg"));
...
void Sktjsckd::__init__() {
	...
	if (m_cEffect != nullptr)
		m_cEffect.Destroy();
	if (m_iTripord[N_sktjsckd][2] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//나선창3.png"));
		setTier3();
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_sktjsckd][1] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//나선창2.png"));
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_sktjsckd][0] != 0) {
...
void Rhlddufvk::setTier1() {
	switch (m_iTripord[N_rhlddufvk][0])
	{
	case 1:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//부위파괴강화1.jpg"));
...
void Rhlddufvk::setTier2() {
	switch (m_iTripord[N_rhlddufvk][1])
	{
	case 1:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//화염회전.jpg"));
		lstrcpy(m_tStr[2], L"화염 회전\n적중한 적에게 화상을 부여한다.\n");
		break;
	case 2:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//절대방어.jpg"));
...
void Rhlddufvk::setTier3() {
	switch (m_iTripord[N_rhlddufvk][2])
	{
	case 1:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//돌격베기.jpg"));
		lstrcpy(m_tStr[3], L"차지 강화\n차징 스킬로 바뀌고 주는 피해와 사거리가 증가한다.\n");
		break;
	case 2:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//마력조절3.jpg"));
...
void Rhlddufvk::__init__() {
	...
	if (m_iTripord[N_rhlddufvk][2] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//굉열파3.png"));
		setTier3();
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_rhlddufvk][1] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//굉열파2.png"));
		setTier1();
		setTier2();
	}
	else if (m_iTripord[N_rhlddufvk][0] != 0) {
	...
	m_eCardname = (CardName)N_rhlddufvk;
	...
	swprintf_s(m_tStr[R_main], 100, L"창에 기를 모아 가까운 적에게 %d피해를 준다.\n부위파괴 : %d\0", m_iDamage, m_iDestruction);
}
...
void Dbtjdrkdcjs::setTier1() {
	switch (m_iTripord[N_dbtjdrkdcjs][0])
	{
	case 1:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//빠른준비1.jpg"));
	...
	case 2:
		...
		break;
	case 3:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//약점포착1.jpg"));
...
void Dbtjdrkdcjs::setTier2() {
	switch (m_iTripord[N_dbtjdrkdcjs][1])
	{
	case 1:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//기절효과.jpg"));
	...
	case 2:
		...
		break;
	case 3:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//대지파괴.jpg"));
...
void Dbtjdrkdcjs::setTier3() {
	switch (m_iTripord[N_dbtjdrkdcjs][2])
	{
	case 1:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//강력한마무리.jpg"));
...
void Dbtjdrkdcjs::__init__() {
	...
	if (m_iTripord[N_dbtjdrkdcjs][2] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//유성강천3.png"));
		setTier3();
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_dbtjdrkdcjs][1] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//유성강천2.png"));
		setTier1();
		setTier2();
	}
	else if (m_iTripord[N_dbtjdrkdcjs][0] != 0) {
	...
	m_eCardname = (CardName)N_dbtjdrkdcjs;
	...
	swprintf_s(m_tStr[R_main], 100, L"위로 점프하여 내리 꽂아 충격파를 일으켜 %d의 피해를 준다.\n\0", m_iDamage);
}
...
void Aodfyddufvk::setTier1() {
	switch (m_iTripord[N_aodfyddufvk][0])
	{
	case 1:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//넓은공격.jpg"));
		lstrcpy(m_tStr[1], L"넓은 공격\n공격 범위가 증가한다.\n");
		break;
	case 2:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//뇌진탕.jpg"));
...
void Aodfyddufvk::setTier2() {
	switch (m_iTripord[N_aodfyddufvk][1])
	{
	case 1:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//빠른준비2.jpg"));
		lstrcpy(m_tStr[2], L"공격 속도 증가\n공격 속도가 증가한다.\n");
		break;
	case 2:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//냉기회전.jpg"));
...
void Aodfyddufvk::setTier3() {
	switch (m_iTripord[N_aodfyddufvk][2])
	{
	case 1:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//공격잇기3.jpg"));
...
void Aodfyddufvk::__init__() {
	...
	if (m_iTripord[N_aodfyddufvk][2] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//맹룡열파3.png"));
		setTier3();
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_aodfyddufvk][1] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//맹룡열파2.png"));
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_aodfyddufvk][0] != 0) {
	...
	m_eCardname = (CardName)N_aodfyddufvk;
	...
	swprintf_s(m_tStr[R_main], 100, L"더욱 큰 창으로 바뀌고 크게 휘둘러 %d의 피해를 준다.\n무력화 : 중\0", m_iDamage);
}
...
void Qksdnjftja::setTier1() {
	switch (m_iTripord[N_qksdnjftja][0])
	{
	case 1:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//부위파괴강화1.jpg"));
		lstrcpy(m_tStr[1], L"부위파괴 강화\n부위 파괴 수치를 +1만큼 증가 시킨다.\n");
...
void Qksdnjftja::setTier2() {
	switch (m_iTripord[N_qksdnjftja][1])
	{
	case 1:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//뇌진탕2.jpg"));
...
void Qksdnjftja::setTier3() {
	switch (m_iTripord[N_qksdnjftja][2])
	{
	case 1:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//강력한마무리.jpg"));
		...
		break;
	case 2:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//날이선일격.jpg"));
...
void Qksdnjftja::__init__() {
	...
	if (m_iTripord[N_qksdnjftja][2] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//반월섬3.png"));
		setTier3();
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_qksdnjftja][1] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//반월섬2.png"));
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_qksdnjftja][0] != 0) {
	...
	m_eCardname = (CardName)N_qksdnjftja;
	...
	swprintf_s(m_tStr[R_main], 100, L"전방으로 긴창을 바닥에 끌면서 이동하여 %d의 피해를 준다.\n무력화 : 중상\0", m_iDamage);
}
...
void Dusghkstja::setTier1() {
	switch (m_iTripord[N_dusghkstja][0])
	{
	case 1:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//급소타격.jpg"));
...
void Dusghkstja::setTier2() {
	switch (m_iTripord[N_dusghkstja][1])
	{
	case 1:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//빠른준비2.jpg"));
		lstrcpy(m_tStr[2], L"공격 속도 증가\n공격 속도가 증가한다.\n");
		break;
	case 2:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//뇌진탕.jpg"));
		lstrcpy(m_tStr[2], L"뇌진탕\n적에게 주는 무력화가 증가한다.\n");
		break;
	case 3:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//파괴하는창.jpg"));
...
void Dusghkstja::setTier3() {
	switch (m_iTripord[N_dusghkstja][2])
	{
	case 1:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//강력한마무리.jpg"));
		...
		break;
	case 2:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//광휘의창.jpg"));
...
void Dusghkstja::__init__() {
	...
	if (m_iTripord[N_dusghkstja][2] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//연환섬3.png"));
		setTier3();
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_dusghkstja][1] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//연환섬2.png"));
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_dusghkstja][0] != 0) {
	...
	m_eCardname = (CardName)N_dusghkstja;
	...
	swprintf_s(m_tStr[R_main], 100, L"창을 위로 올려친 후 앞으로 전진하여 베기공격을하여 %d의 피해를 준다.\n부위파괴 : %d\0", m_iDamage, m_iDestruction);
}
...
void Cjdfydwls::setTier1() {
	switch (m_iTripord[N_cjdfydwls][0])
	{
	case 1:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//뇌진탕.jpg"));
		lstrcpy(m_tStr[1], L"뇌진탕\n적에게 주는 무력화가 증가한다.\n");
...
void Cjdfydwls::setTier2() {
	switch (m_iTripord[N_cjdfydwls][1])
	{
	case 1:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//내려치는창.jpg"));
		lstrcpy(m_tStr[2], L"창 소환\n창을 찍지 않는 대신 창을 소환하여 떨군다.\n");
		break;
	case 2:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//집중공략.jpg"));
...
void Cjdfydwls::setTier3() {
	switch (m_iTripord[N_cjdfydwls][2])
	{
	case 1:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//공격잇기3.jpg"));
		lstrcpy(m_tStr[3], L"카드 뽑기\n카드를 한 장 뽑는다.\n");
...
void Cjdfydwls::__init__() {
	...
	if (m_iTripord[N_cjdfydwls][2] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//청룡진3.png"));
		setTier3();
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_cjdfydwls][1] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//청룡진2.png"));
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_cjdfydwls][0] != 0) {
	...
	m_eCardname = (CardName)N_cjdfydwls;
	...
	swprintf_s(m_tStr[R_main], 100, L"제자리에서 창을 강하게 내려찍어 충격파가 퍼져 %d의 피해를 준다.\n부위파괴 : %d\0", m_iDamage, m_iDestruction);
}
...
void Cjdfydcnftn::setTier1() {
	switch (m_iTripord[N_cjdfydcnftn][0])
	{
	case 1:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//급소타격.jpg"));
		lstrcpy(m_tStr[1], L"급소 타격\n적에게 주는 피해가 증가한다.\n");
		break;
	case 2:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//치명적인공격.jpg"));
...
void Cjdfydcnftn::setTier2() {
	switch (m_iTripord[N_cjdfydcnftn][1])
	{
	case 1:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//나선찌르기.jpg"));
		lstrcpy(m_tStr[2], L"풍속성 부여\n위 아래 적을 끌어당긴다.\n");
		break;
	case 2:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//화력조절2.jpg"));
		lstrcpy(m_tStr[2], L"게이지 수급\n각성기 게이지를 추가 수급한다.\n");
		break;
	case 3:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//넓은타격.jpg"));
...
void Cjdfydcnftn::setTier3() {
	switch (m_iTripord[N_cjdfydcnftn][2])
	{
	case 1:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//돌격베기.jpg"));
...
void Cjdfydcnftn::__init__() {
	...
	if (m_iTripord[N_cjdfydcnftn][2] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//청룡출수3.png"));
		setTier3();
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_cjdfydcnftn][1] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//청룡출수2.png"));
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_cjdfydcnftn][0] != 0) {
	...
	m_eCardname = (CardName)N_cjdfydcnftn;
	...
	swprintf_s(m_tStr[R_main], 100, L"전방으로 전진한 후 창을 빠르게 휘둘러 %d의 피해를 준다.\n무력화 : 중\0", m_iDamage);
}
...
void Ghltjsckd::setTier1() {
	switch (m_iTripord[N_ghltjsckd][0])
	{
	case 1:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//탁월한기동성.jpg"));
		lstrcpy(m_tStr[1], L"탁월한 기동성\n사용 후 이동속도가 증가한다.\n");
	...
	case 2:
		...
		break;
	case 3:
		m_cImg[R_tier1].Load(TEXT(".//카드관련//트포//회전올려치기.jpg"));
...
void Ghltjsckd::setTier2() {
	switch (m_iTripord[N_ghltjsckd][1])
	{
	case 1:
		m_cImg[R_tier2].Load(TEXT(".//카드관련//트포//정신파괴.jpg"));
...
void Ghltjsckd::setTier3() {
	switch (m_iTripord[N_ghltjsckd][2])
	{
	case 1:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//연속회전.jpg"));
		lstrcpy(m_tStr[3], L"연속 공격\n이 카드를 1회 가져온다.\n");
		break;
	case 2:
		m_cImg[R_tier3].Load(TEXT(".//카드관련//트포//공격잇기3.jpg"));
...
void Ghltjsckd::__init__() {
	...
	if (m_iTripord[N_ghltjsckd][2] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//회선창3.png"));
		setTier3();
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_ghltjsckd][1] != 0) {
		m_cImg[0].Load(TEXT(".//카드관련//카드//회선창2.png"));
		setTier2();
		setTier1();
	}
	else if (m_iTripord[N_ghltjsckd][0] != 0) {
	...
	m_eCardname = (CardName)N_ghltjsckd;
	m_iMana = 5, m_iDamage = 9, m_iNeutralization = 10, m_iDestruction = 0;

	lstrcpy(m_tNameStr, L"회선창");
	m_cSkill.Load(TEXT(".//카드관련//스킬초상화//회선창.png"));
	swprintf_s(m_tStr[R_main], 100, L"전방으로 회전하여 %d의 피해를 준다.\n무력화 : 하\0", m_iDamage);
}

Dmsgkdbtjdxks::Dmsgkdbtjdxks(CImage* manaImg) {
	...
	m_eCardname = (CardName)N_dmsgkdbtjdxks;
	...
	swprintf_s(m_tStr[R_main], 100, L"위로 점프한 후 창을 던진다. 창이 땅에 떨어지면 %d의 피해를 주고 서서히 폭발한다.\n부위파괴 : %d, 무력화 : 최상\0", m_iDamage, m_iDestruction);
}